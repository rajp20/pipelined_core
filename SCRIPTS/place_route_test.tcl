...
proc import_design {{how "init"}} {
   ...
   switch $how {
      "init"      {  uplevel #0 source CONF/core.globals
                     init_design
                     save_design import
                  }
...
proc export_design {} {
   ...
   put_header "Exporting design..."
	...
	exec mkdir -p ../verilog/mapped
   #To be used for importing into Virtuoso
   saveNetlist -excludeLeafCell -includePowerGround "../verilog/mapped/${design}_placed_virtuoso.v"
#   saveNetlist -excludeLeafCell -includePowerGround "../HDL/MAPPED/${fname}_virtuoso.v"
   #To be used for modelsim verification (does not contain VDD/VSS ports)
   saveNetlist -excludeLeafCell "../verilog/mapped/${design}_placed_modelsim.v"

	exec mkdir -p SDF
	#write_sdf ‐view wc SDF/${design}_placed.sdf
	write_sdf SDF/${design}_placed.sdf
  # saveNetlist -excludeLeafCell "../HDL/MAPPED/${fname}_modelsim.v"
