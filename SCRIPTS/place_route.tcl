...
proc export_design {} {
   ...
   set lib [string toupper $design]
	...
	mkdir -p ../verilog/mapped
   #To be used for importing into Virtuoso
   saveNetlist -excludeLeafCell -includePowerGround "../verilog/mapped/${fname}_virtuoso.v"
#   saveNetlist -excludeLeafCell -includePowerGround "../HDL/MAPPED/${fname}_virtuoso.v"
   ...
   saveNetlist -excludeLeafCell "../verilog/mapped/${fname}_modelsim.v"
