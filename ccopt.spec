...
#  Generated on:      Mon Dec  2 20:25:48 2019
...
#   clk (period 15.000ns) in timing_config constraint([./SDC/Core_mapped.sdc])
create_ccopt_clock_tree -name clk -source clk -no_skew_group

# Clock period setting for source pin of clk
set_ccopt_property clock_period -pin clk 15

# Skew group to balance non generated clock:clk in timing_config:constraint (sdc ./SDC/Core_mapped.sdc)
